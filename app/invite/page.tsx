...
<div className="glitter w-2 h-2 sm:w-3 sm:h-3 top-40 left-1/2 sm:left-3/4"></div>
      ...
      <div className="w-full max-w-sm mx-auto space-y-5">
        ...
        <motion.h1
          ...
          className={`${greatVibes.className} text-3xl text-purple-900 drop-shadow-lg`}
        >
          Dineshkumar C
        </motion.h1>
        ...
        <motion.h2
          ...
          className={`${greatVibes.className} text-2xl text-purple-900 drop-shadow-lg`}
        >
          ་༘࿐ ִֶָ💍࿐་༘
        </motion.h2>
        ...
        <motion.p
          ...
          className={`${merriweather.className} text-base text-gray-700 mb-6`}
        >
        ...
        <motion.button
          ...
          className="px-4 py-1.5 bg-purple-700 text-white text-sm rounded-full 
