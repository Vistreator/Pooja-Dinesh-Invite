...
<div className="glitter w-2 h-2 sm:w-3 sm:h-3 top-40 left-1/2 sm:left-3/4"></div>
      ...
      {/* Title */}
      <h1 className={`${merriweather.className} text-3xl font-bold text-purple-900 drop-shadow mb-4`}>
        𝓓 <span className="text-purple-700">♥</span> 𝓟
      </h1>
      ...
      <button
        onClick={handleClick}
        className="w-28 h-28 rounded-full bg-purple-700 text-white font-bold 
